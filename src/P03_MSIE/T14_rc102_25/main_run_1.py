...
RUN_NAME = "rc102_25"
RUN_DESCRIPTION = "Training on rc102_25 problem set"
RUN_TYPE = "NEW"
LEARN_TIMESTEPS = 400000
PROBLEM_SET = "rc102_25"
...
default_rl_input_params = RL_INPUT_PARAMS(
...
_, benchmark_result = load_vrptw(
    vpr_input_params, default_rl_input_params, return_benchmark=True
)
default_rl_input_params.target_solution = benchmark_result * 0.98
rl_input_params = default_rl_input_params
